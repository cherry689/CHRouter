...
Pod::Spec.new do |s|
  s.name             = 'CHRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CHRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mingren/CHRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mingren' => '853355024@qq.com' }
  s.source           = { :git => 'https://github.com/mingren/CHRouter.git', :tag => s.version.to_s }
